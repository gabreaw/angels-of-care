...
export default function Hero() {
  return (
    <section id="inicio" className="relative bg-gradient-to-br from-sage/20 via-paper to-beige/30 py-20 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <h1 className="text-4xl md:text-5xl lg:text-6xl text-primary leading-tight">
              Cuidado que conforta, <br/>presença que acolhe.
            </h1>
            <p className="text-lg text-darkText/80 font-sans leading-relaxed">
              Conectamos sua família a cuidadores qualificados e apaixonados pelo que fazem. 
              Assistência profissional para idosos, pós-operatório e gestantes com o carinho que eles merecem.
            </p>
            ...
            <div className="space-y-4 pt-4">
              ...
              <div className="flex items-center gap-2 text-primary font-medium">
                ...
                <span className="text-sm">Mais de 10 anos de experiência em cuidado.</span>
              </div>
            </div>
          </div>
