...
import { UserPlus, Phone, Search, UserCheck, UserX } from "lucide-react";
    ...
    <div className="bg-white rounded-2xl shadow-lg border border-beige overflow-hidden mb-8">
      ...
      <div className="p-4 bg-sage/10 border-b border-beige flex items-center gap-2">
        ...
        <h3 className={`font-bold text-lg ${corTitulo}`}>
          {titulo}{" "}
          <span className="text-sm font-normal opacity-70 text-darkText">
            ({dados.length})
          </span>
        </h3>
      </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
          <div>
            ...
            <p className="text-darkText/60">
              Gerencie ativos e inativos em listas separadas.
            </p>
          </div>
          <Link
